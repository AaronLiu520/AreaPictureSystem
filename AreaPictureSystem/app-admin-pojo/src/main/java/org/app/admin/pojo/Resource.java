...
public class Resource extends GeneralBean {
	...
	*/ 
	...
	private String person; 				//被拍摄者
	private String photographer;		//拍摄者
	private String uploadPerson;		//上传者
	private Date resourceTime;			//文件日期
	private String resourceAddress; 	//资源地址
	...
	private String min_generateName;	//缩略图（小）
	private String middle_generateName; //缩略图（中）
	private String max_generateName;	//缩略图（大）
	@DBRef
