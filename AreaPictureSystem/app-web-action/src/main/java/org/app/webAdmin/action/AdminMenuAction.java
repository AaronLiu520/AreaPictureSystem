...
public class AdminMenuAction extends GeneralAction<AdminMenu> {
	...
	public ModelAndView list(HttpSession session) {
		...
		try {
			...
			query.addCriteria(Criteria.where("isWebMenu").is(false));
	...
	public ModelAndView list(HttpSession session, AdminMenu adminMenu) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("redirect:/adminMenu/list");
		
		adminMenu.setWebMenu(false);
	...
	public ModelAndView editor(HttpSession session,String id) {
		...
		AdminMenu menu = this.adminMenuService.findOneById(id, AdminMenu.class);
		System.out.println(menu.getWebUrl());
		try {
			if(id!=null && id!=""){
