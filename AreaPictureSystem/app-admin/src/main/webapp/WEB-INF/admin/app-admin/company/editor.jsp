								...
								<form role="form" id="form"
									...
									<div class="row">
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												<input value="${bean.name}" id="name" name="name"
													type="text" placeholder="请输入名称" class="form-control"
													required>
											</div>
										</div>
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												<input value="${bean.shorts}" name="shorts" type="text"
													placeholder="简称" class="form-control">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												<input value="${bean.address}" id="address" name="address"
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												<input value="${bean.contacts}" type="text" name="contacts"
													placeholder="请输入联系人" class="form-control" required>
											</div>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<div class="row">
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												<input value="${bean.telPhone}" id="telPhone"
													name="telPhone" type="text" placeholder="请输入电话"
