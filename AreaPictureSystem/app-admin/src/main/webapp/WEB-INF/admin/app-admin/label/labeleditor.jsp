								...
								<form role="form" id="form" action="createOrUpdateToFind"
									...
									<div class="row">
										<div class="form-group">
											<label class="col-sm-8 control-label">标签名称</label>
											<div class="col-sm-10">
												<input type="text" id="labelName" value="${bean.labelName}"
													name="labelName" class="form-control" placeholder="标签名称"
													required>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<label class="col-sm-8 control-label">创建老师Id</label>
											<div class="col-sm-10">
												<input type="text" id="userid" value="${bean.userid}"
													name="userid" class="form-control" placeholder="创建老师Id"
													required>
											</div>
										</div>
									</div>
                                    <div class="row">
										<div class="form-group">
											<label class="col-sm-8 control-label">单位ID</label>
											<div class="col-sm-10">
												<input type="text" id="companyid" value="${bean.companyid}"
													name="companyid" class="form-control" placeholder="单位ID"
													required>
											</div>
										</div>
									</div> 
